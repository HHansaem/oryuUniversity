...
@Controller
@RequestMapping("/academicBusinessPlan/aBPUploadImage.do")
public class ABPUploadImageController {
	...
	@ResponseBody
	public Map<String, Object> aBPUploadHandler(@RequestPart("upload") MultipartFile upload, HttpServletRequest req) throws IllegalStateException, IOException {
