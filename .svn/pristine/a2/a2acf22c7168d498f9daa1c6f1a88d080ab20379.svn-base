	...
	<table class="table table-bordered" style="width: 98%; margin: 0 0 23px 35px;">
		...
		<div class="btnInfo">
			<c:url value="/lecture/noticeList.do" var="ListURL" >
				...
				<input type="submit" id="updateBtn" id="updateBtn" class="btn btn-outline-info" value="수정">
				<a class="btn btn-outline-secondary" style="margin-left: 5px;"href="${pageContext.request.contextPath}/lecture/noticeList.do?lecCd=${lecCd }">취소</a>
		</div>
	</div>
	</div>
	</div>
