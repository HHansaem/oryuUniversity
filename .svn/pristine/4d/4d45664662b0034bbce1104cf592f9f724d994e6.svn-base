...
@Controller
@RequestMapping("/academicBusinessReport/aBRUploadImage.do")
public class ABRUploadImageController {
	...
	@ResponseBody
	public Map<String, Object> uploadHandler(@RequestPart("upload") MultipartFile upload, HttpServletRequest req)
