...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/vendors/ti-icons/css/themify-icons.css">
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/js/select.dataTables.min.css">
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/album.css">
<!--   font -->
...
<body class="sidebar-icon-only font-style" id="body">
...
<!-- 						style="background-color: #154FA9; height: 50px;"></div> -->
