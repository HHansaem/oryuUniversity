		...
		<div class="custom-card">
			...
			<div class="card-body">
					<div class="row justify-content-center">
						...
						<div class="col-4">
							<button id="insertRow" class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">알림등록</button>
						</div>
					</div>
				</div>
				<div class="row justify-content-center">
								...
								<c:choose>
									...
									<c:otherwise>
										<c:forEach items="${noticeList }" var="notice">
											<tr data-id="${notice.notiCd}" class="clickable-row">
												<td class="col-1">${notice.notiCd}</td>
												<td class="col-1">${notice.sender}</td>
												<td class="col-1">${notice.receiver}명</td>
												<td class="col-1">${notice.count}명</td>
...
<%--         window.location.href = "<%=request.getContextPath()%>/notice/noticeView.do?notiCd=" + id; --%>
//       });
// });
