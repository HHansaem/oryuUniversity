...
<div class="card box-shadow d-flex m-4" style="min-height: 30%;">
	<div class="h-100">
		<div class="card-header"
			style="border-radius: 20px 20px 0 0; background-color: #154FA9; font-weight: bold; color: white;">교수계정
			등록 및 조회</div>
		<div id="prForm" style="display: none;">
			<div id="professorForm"></div>
			<div class="gradInfo-header" style="padding: 20px 60px 0px 20px;">
				<i class="mdi mdi-check-circle" style="color: green;"></i> 교수정보 조회
				<hr
		...
		<table style="margin-bottom: 10px;">
			...
			<td
				...
				name="prStatus" class="form-select" id="selectprStatus">
			...
			<td
				...
				<div id="searchUI" class="form-inline">
					...
					<input type="button" value="검색" id="searchBtn"
						...
						value="교수 등록" id="showFormButton"
						class="btn btn-outline-info text-center"
						style="height: 40px; line-height: 0; margin-left: 170px;">
				</div>
			</td>
		</table>
